...
{
	Movie fightClub("Fight Club", "David Fincher", { "Drama" ,"Thriller" }, { "Edward Norton" ,"Brad Pitt" }, "1999", {"shot-FightClubV1.png", "shot-FightClubV2.png"}, "FightClub.png", "An insomniac office worker and a devil-may-care soap maker form an underground fight club that evolves into much more.");
	Movie aNewHope("A New Hope", "George Lucas", { "Action" ,"Adventure","Fantasy", "Sci-Fi" }, { "Mark Hamill" ,"Harrison Ford" }, "1977", {"shot-ANewHopeV1.png","shot-ANewHopeV2.png" ,"shot-ANewHopeV3.png" }, "ANewHope.png", "aaaaaaaaaa aaaaaaaaaa aaaaaaaaaa aaa");
